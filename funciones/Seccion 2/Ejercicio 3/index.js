...
let l=parseFloat(prompt("ingrese valor del lado un cubo"));

function cubo(l) {
    let volumen_de_cubo=Math.pow(l,3);
    return volumen_de_cubo;
}

let volumen1=parseFloat(cubo(l).toFixed(3));
console.log("este es el volumen de un cubo:",volumen1);
